...
# c.TerminalInteractiveShell.banner1 = 'Python 3.4.2 (default, Oct 20 2014, 23:35:22) \nType "copyright", "credits" or "license" for more information.\n\nIPython 2.3.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# Require Shift-Enter to submit execution
c.IPythonWidget.execute_on_complete_input = False

# Inline plots extend off the side otherwise
c.IPythonWidget.width = 112

# Keep qtconsole aspect ratio
c.IPythonWidget.height = 35
